...
import time,random,sys,json,os,codecs,threading,glob,re,requests,urllib,urllib2,urllib3
...
cl = LINETCR.LINE()
cl.login(token="EnUqZDMuLRQemLoTF1J1.tBHLGaKLv6oecfwOx89Meq.NoKJqszd5MEZpuOWW4vu6OfJnf+jWC9l47bYGTXfuHs=")
cl.loginResult()
...
==>"Instagram.com/Andrii.Setiiawan"<==
...
Bots=[mid,"uc9cf626eb815a70d59c8e71f9fda4872"]
admin=["uc9cf626eb815a70d59c8e71f9fda4872"]
wait = {
    'contact':False,
    'autoJoin':True,
    'alwayRead':False,
        ...
        if op.type == 13:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["ᴅᴏɴᴛ ᴛᴀɢ ᴍᴇ!! ɪᴍ ʙᴜsʏ",cName + " ɴɢᴀᴘᴀɪɴ ɴɢᴇᴛᴀɢ?",cName + " ɴɢɢᴀᴋ ᴜsᴀʜ ᴛᴀɢ-ᴛᴀɢ! ᴋᴀʟᴏ ᴘᴇɴᴛɪɴɢ ʟᴀɴɢsᴜɴɢ ᴘᴄ ᴀᴊᴀ","-_-","ɢᴇʙᴏɴɢ sᴇᴅᴀɴɢ ᴏғғ", cName + " ᴋᴇɴᴀᴘᴀ ᴛᴀɢ sᴀʏᴀ?","sᴘᴀᴍ ᴘᴄ ᴀᴊᴀ " + cName, "ᴊᴀɴɢᴀɴ sᴜᴋᴀ ᴛᴀɢ ɢᴜᴀ " + cName, "ᴋᴀᴍᴜ sɪᴀᴘᴀ ? " + cName + "?", "ᴀᴅᴀ ᴘᴇʀʟᴜ ᴀᴘᴀ ? " + cName + "?","ᴀᴅᴀ ᴀᴘᴀ sᴀʏᴀɴɢ","Tersummon -_-"]
                     ret_ = "[ɓσϯ] " + random.choice(balas)
	...
	if op.type == 26:
		...
		ki.sendMessage(msg)
              ...
              if msg.from_ in admin:
                ...
                wait['alwayRead'] = True
                cl.sendText(msg.to,"αմϯσ ςίδεɾ ση")
                
            elif msg.text in ["Read off","Read:off"]:
                wait['alwayRead'] = False
                cl.sendText(msg.to,"αմϯσ ςίδεɾ σƒƒ")
...
#-----------------------------------------------
      ...
      #-------------Fungsi Bannlist Finish------------------#  
        ...
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "Semoga Amal Ibadahnya Diterima🙂 ")
